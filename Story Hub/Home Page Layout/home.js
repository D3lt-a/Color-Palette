...
function displayRecentStories() {
    ...
    //make it sort stories by date, most recent first
    stories.sort((a, b) => new Date(b.date) - new Date(a.date));
    
    // Remember to make it display 3 most recent stories
    stories.slice(0, 3).forEach(story => {
        ...
        storyItem.innerHTML = `
            ...
            <p>${story.content.substring(0, 100)}... <a href="../Stories/stories.html">Read more</a></p>
        `;
